...
<section class="max-w-5xl mx-auto px-6 pt-20 pb-12 flex flex-col items-center text-center">
    ...
    <div class="flex flex-col sm:flex-row gap-4 justify-center">
        <a href="{{ route('contact') }}" class="bg-brand-green hover:bg-brand-green/80 text-zinc-950 font-semibold px-8 py-3 rounded-lg transition-colors">
            Start a project
        </a>
        <a href="{{ route('fun') }}" class="border border-zinc-700 hover:border-brand-green text-zinc-300 hover:text-white font-semibold px-8 py-3 rounded-lg transition-colors">
            See something fun
        </a>
    </div>
</section>
...
<section class="max-w-5xl mx-auto px-6 pb-28">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-3 gap-6">
        ...
        <div class="bg-zinc-900 border border-zinc-800 rounded-2xl p-8 hover:border-brand-green/40 transition-colors">
